...
.. command:: boosttest_discover_tests
  ...
  ``boosttest_discover_tests`` sets up a post-build command on the test
  ...
  ``TEST_NAME_SEPARATOR``
    With Boost.Test a test case can be contined in one or more test suites.
...
function(boosttest_discover_tests TARGET)
  ...
  if(NOT __DISCOVERY_MODE)
    if(NOT BOOSTTEST_DISCOVER_TESTS_DISCOVERY_MODE)
      set(BOOSTTEST_DISCOVER_TESTS_DISCOVERY_MODE "POST_BUILD")
    endif()
